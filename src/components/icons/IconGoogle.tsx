      ...
      <g id="Logo" transform="translate(3 3)">
        <g id="Clipped">
          <path
            ...
            fill="none"
          />
          <g id="Clipped-2" data-name="Clipped" clipPath="url(#clip-path)">
            <path
              id="Path"
        ...
        <g id="Clipped-3" data-name="Clipped">
          <path
            ...
            fill="none"
          />
          <g id="Clipped-4" data-name="Clipped" clipPath="url(#clip-path)">
            <path
              id="Path-2"
              data-name="Path"
        ...
        <g id="Clipped-5" data-name="Clipped">
          <path
            ...
            fill="none"
          />
          <g id="Clipped-6" data-name="Clipped" clipPath="url(#clip-path)">
            <path
              id="Path-3"
              data-name="Path"
        ...
        <g id="Clipped-7" data-name="Clipped">
          <path
            ...
            fill="none"
          />
          <g id="Clipped-8" data-name="Clipped" clipPath="url(#clip-path)">
            <path
              id="Path-4"
              data-name="Path"
